<template>
    <main>
      ...
      <p>All Clients: {{ organizationClients }}</p>
      <br>
      <p>Current Client: {{ client }}</p>
      <br>
      <p>Organization Events: {{ organizationEvents }}</p>
      <br>
      <p>Organization Event Clients: {{ organizationEventClients }}</p>
      <br>
      <p>clientEvents: {{ clientEvents }}</p>
      <br>
      <p>eventsFiltered: {{ eventsFiltered }}</p>
      <br>
      <p>eventsSelected: {{ eventsSelected }}</p>
...
export default {
  ...
  data() {
    return {
      ...
      // events that the client is not registered in
      eventsFiltered: [],
  ...
  mounted() {
    ...
    //For the multi select, it will only show the selection of events
  ...
  methods: {
    ...
    addToEvent() {
        ...
        console.log('test:', eventIdsToAdd)
    ...
    // Dispatch the mutation to delete the client from the store
    this.$store.commit('deleteClient', this.client.id)

    // Show a success message
    alert('Client has been deleted.')

    // Navigate to the find clients page
