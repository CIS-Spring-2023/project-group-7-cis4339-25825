<template>
    <main>
      ...
      <br>
      <p>Organization Services: {{ organizationServices }}</p>
      <br>
      <p>Organization Event Services: {{ organizationEventServices }}</p>
      <br>
...
export default {
  ...
  methods: {
    async handleSubmitForm() {
      ...
      if (isFormCorrect) {
        this.event.id = this.organizationEvents.length + 1
        console.log('this.event:', this.event)
        console.log('this.eventServiceIds:', this.eventServiceIds)
        const payload = {
          event: this.event,
