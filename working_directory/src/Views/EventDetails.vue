<template>  
    <main>
      ...
      <p>organizationEvents: {{ organizationEvents }}</p>
      <br>
      <p>event: {{ event }}</p>
      <br>
      <p>organizationServices: {{ organizationServices }}</p>
      <br>
      <p>organizationEventServices: {{ organizationEventServices }}</p>
      <br>
      <p>eventServiceIds: {{ eventServiceIds }}</p>
      <br>
      <p>eventServices: {{ eventServices }}</p>
      <br>
      <p>organizationEventClients: {{ organizationEventClients }}</p>
...
export default {
  ...
  mounted() {
    ...
    if (event_temp) {
        ...
        console.log('event services array: ', this.eventServices)
        ...
        console.log('eventClients:', this.eventClients)
    }
  },
  computed: {
  ...
  methods: {
    ...
    async handleEventUpdate() {
      ...
      if (isFormCorrect) {
        ...
        console.log('eventserviceids in vue:', this.eventServiceIds)
